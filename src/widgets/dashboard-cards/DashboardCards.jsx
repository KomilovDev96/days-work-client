...
const DashboardCards = () => {
    ...
    const { data, isLoading } = useQuery({
        ...
        queryFn: async () => {
            ...
            const todayResp = await apiClient.get(`/reports/period?startDate=${today}&endDate=${today}&userId=${user?._id || ''}`);
            const weekResp = await apiClient.get(`/reports/period?startDate=${startOfWeek}&endDate=${today}&userId=${user?._id || ''}`);
